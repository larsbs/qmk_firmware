...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT_all(
		...
		KC_LCTL, KC_LGUI, KC_LALT, _______, KC_SPC, _______, KC_RGUI, MO(1), KC_LEFT, KC_DOWN, KC_RGHT
    ),

    LAYOUT_all(
        RESET, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, _______, _______,
		_______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, KC_END, KC_PGUP, KC_HOME, KC_INS,
		_______, BL_TOGG, BL_STEP, BL_INC, BL_DEC, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, _______, KC_PGDN, _______,
